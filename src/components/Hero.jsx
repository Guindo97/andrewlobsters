      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        <div className={`text-center text-white max-w-6xl mx-auto transition-all duration-1000 ${
          ...
          <div className="mb-8">
            ...
            <p className="text-3xl md:text-4xl font-bold mb-6 text-white drop-shadow-lg">
              The Place to Be for Sea Food
            </p>
            <p className="text-xl md:text-2xl text-white/90 mb-8 leading-relaxed max-w-4xl mx-auto drop-shadow-md">
              {t.hero.subtitle}
            </p>
            <p className="text-lg text-white/80 mb-8 max-w-3xl mx-auto drop-shadow-md">
              {t.hero.description}
            </p>
            <div className="text-xl font-semibold text-white/90 mb-12 drop-shadow-md">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            <button
              ...
              className="bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white px-12 py-5 rounded-full font-bold text-xl hover:scale-105 transform transition-all shadow-2xl relative overflow-hidden group border-2 border-white/20"
            >
