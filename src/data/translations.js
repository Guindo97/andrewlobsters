...
export const translations = {
  en: {
    ...
    hero: {
      ...
      subtitle: "Fresh, locally caught lobster — cooked daily and ready to enjoy",
      description: "Straight from our boat to your home, it's more than a meal — it's family tradition.",
      cta: "Order Now"
    },
    about: {
      title: "Welcome to Andrew's Lobster! 🦞",
    ...
    cart: {
      ...
      pickup: "Pickup",
      delivery: "Delivery",
      pickupDesc: "Pick up at our location",
    ...
    delivery: {
      ...
      available: "Delivery available in Bathurst area",
      fee: "Delivery fee: $5",
      time: "Delivery time: 1-2 hours"
    },
    gallery: {
      title: "Gallery",
  ...
  fr: {
    ...
    hero: {
      title: "Andrew's Lobsters",
      subtitle: "Homard frais pêché localement — cuit quotidiennement et prêt à déguster",
      description: "Directement de notre bateau à votre maison, c'est plus qu'un repas — c'est une tradition familiale.",
      cta: "Commander Maintenant"
    },
    about: {
      title: "Bienvenue chez Andrew's Lobster! 🦞",
    ...
    cart: {
      ...
      pickup: "Ramassage",
      delivery: "Livraison",
      pickupDesc: "Ramasser à notre emplacement",
      deliveryDesc: "Nous livrerons à votre adresse",
      deliveryFee: "Frais de Livraison",
      noDeliveryFee: "Aucun frais de livraison"
    },
    delivery: {
      title: "Information de Livraison",
      available: "Livraison disponible dans la région de Bathurst",
      fee: "Frais de livraison: 5$",
      time: "Temps de livraison: 1-2 heures"
    },
    gallery: {
      title: "Galerie",
